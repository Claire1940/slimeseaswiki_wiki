...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
	...
	const description =
		'Slime Seas Wiki with fresh codes, race tier picks, weapon guides, boss routes, islands, and progression help for the fast-growing Roblox anime RPG.'
